...
int rand() {
    seed = (1664525 * seed + 1013904223);  // Standard LCG formula with constants
...
void scheduler(void)
{
  ...
  for (;;)
  {
    ...
    #endif
    #ifdef MLFQ
    //send all runnable process to the queue
    ...
    {if(queuesize[level]!=0)
      {runnow = mlfqueue[level][0];dequeue(runnow);break;}}
